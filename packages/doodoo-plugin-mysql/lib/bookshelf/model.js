...
module.exports = function(bookshelf) {
    ...
    bookshelf.Model = bookshelf.Model.extend({
        ...
        _destroy: function(options = {}) {
            return modelPrototype.destroy.call(
                this,
                Object.assign({ require: false }, options)
            );
        },

        destroy: async function(options = {}) {
            if (options.withRedisKey) {
                await doodoo.redis.delAll(options.withRedisKey);
            }
        ...
        _save: function(options = {}) {
            return modelPrototype.save.call(
                this,
                null,
                Object.assign({ require: false }, options)
            );
        ...
        save: async function(options = {}) {
            ...
            return this._save.call(this, options).then(res => {
                return res ? res.toJSON() : "";
            });
        },
        ...
        fetch: async function(options = {}) {
            if (options.withRedisKey) {
                const cache = await doodoo.redis.cache(options.withRedisKey);
                if (!_.isNil(cache)) {
                    return cache;
                } else {
                    return this._fetch
                        ...
                        .then(res => {
                            doodoo.redis.cache(options.withRedisKey, res);
                            return res;
                        });
                }
            }
