...
class Doodoo extends Koa {
        ...
        if (yn(process.env.MYSQL)) {
            ...
            this.model = model => {
                if (doodoo.models[model]) {
                    ...
                    return (doodoo.models[
                        model
                    ] = doodoo.bookshelf.Model.extend({
                        tableName: model,
                        hasTimestamps: true
                    }));
                }
    ...
    /**
     * Use a plugin
     * @description The plugin or plugins to add. If you provide a string it can
